...
Data sources allow data to be fetched or computed for use elsewhere in [locals](/docs/hcl2/blocks/locals) and
[sources](/docs/hcl2/blocks/source) configuration.
